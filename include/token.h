...
namespace vlark
{
    ...
    {
    public:
        [[nodiscard]] token(char const *start, auto count, source_position p, token_type type)
            : sv{start, count}, pos{p}, tok_type{type}
        {
        }

        [[nodiscard]] token(char const *sz, source_position p, token_type type)
            : sv{sz}, pos{p}, tok_type{type}
        {
        }
        ...
        source_position position() const { return pos; }
